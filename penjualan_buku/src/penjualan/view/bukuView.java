 ...
 * @author student
 */
public final class bukuView extends javax.swing.JFrame {
    ...
    void isiTabel(){
        ...
        for(barang brg:record){
            ...
            String judul[] = {"Kode Buku","Nama Buku","Jumlah","Harga"};
    ...
    private void initComponents() {
        ...
        tabelBarang.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Kode Buku", "Nama Buku", "Jumlah", "Harga"
            }
        ));
        jScrollPane1.setViewportView(tabelBarang);
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(namaBarang, javax.swing.GroupLayout.PREFERRED_SIZE, 347, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(kodeBarang, javax.swing.GroupLayout.PREFERRED_SIZE, 450, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {hapusBarang, jButton1, tambahBarang, ubahBarang});

        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {harga, jumlah, kodeBarang, namaBarang});
        ...
        layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {hapusBarang, jButton1, tambahBarang, ubahBarang});

        layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {harga, jumlah, namaBarang});
    ...
    private void tambahBarangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tambahBarangActionPerformed
        ...
        if(cekkodeBarang.trim().isEmpty()){
            JOptionPane.showMessageDialog(null, "Kode Buku belum di isi!");
        }else if(ceknamaBarang.trim().isEmpty()){
            JOptionPane.showMessageDialog(null, "Nama Buku belum di isi!");
    ...
    private void ubahBarangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ubahBarangActionPerformed
        ...
        if(cekkodeBarang.trim().isEmpty()){
            JOptionPane.showMessageDialog(null, "Pilih buku yang ingin diubah!");
        }else{
            try{
                barang brg = new barang();
                brg.setkodeBarang(kodeBarang.getText());
                ...
                brgServis.update(brg);
                        this.statusAwal();
                        JOptionPane.showMessageDialog(this, "Data buku berhasil dirubah!");
            }
            catch(SQLException ex){
                Logger.getLogger(bukuView.class.getName()).log(Level.SEVERE, null, ex);
            }
